  ...
  public async up() {
    ...
    this.schema.createTable(this.tableName, (table) => {
      ...
      table
        ...
        .defaultTo(0)
        .notNullable()
        .comment("Залог, если равен 0, то отсутствует");
      table
        .integer("commission")
        .unsigned()
        .defaultTo(0)
        .notNullable()
        .comment(
          "Комиссия, может быть значением от 0 до 100 процентов, но никак не выше"
        );
      ...
      table
        ...
        .defaultTo(0)
        .notNullable()
        .comment("Можно ли с детьми. 0 - можно, 1 - нет");
      table
        .boolean("withPets")
        .defaultTo(0)
        .notNullable()
        .comment("Можно ли с животными. 0 - можно, 1 - нет");
      ...
      table
        ...
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли наземная парковка");
      table
        .boolean("hasUnderGroundParking")
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли подземная парковка");
      table
        .boolean("hasMoreLayerParking")
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли многоуровневая парковка");
      table
        .boolean("hasYardParking")
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли дворовая парковка");
      table
        .boolean("hasBarrierParking")
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли парковка с шлагбаумом");
      ...
      table
        ...
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли ипотека");
      table
        .boolean("isEncumbrances")
        .defaultTo(0)
        .notNullable()
        .comment("Есть ли обременения");
      ...
      table
        ...
        .defaultTo(0)
        .notNullable()
        .comment("Срочная продажа или нет (статус hot)");
      ...
      table
        ...
        .unsigned()
        .nullable()
        .comment("Есть только у жилого типа объекта");
      ...
      `);
      table
        .integer("communalPrice")
        .unsigned()
        .nullable()
        .comment(
          "Включая коммунальные платежи. Если пустое, то сделка является продажей."
        );
      ...
      table
        ...
        .unsigned()
        .nullable()
        .comment("Жилая площадь в метрах в квадрате");
      table
        .integer("kitchenArea")
        .unsigned()
        .nullable()
        .comment("Площадь кухни");
      table
        .integer("acres")
        .unsigned()
        .nullable()
        .comment("Площадь соток, есть только у земельных участков");
      table
        .integer("cityDistance")
        .unsigned()
        .nullable()
        .comment("Расстояние до города, есть только у земельных участков");
      table
        .integer("maxFloor")
        .unsigned()
        .nullable()
        .comment(
          "Максимальное кол-во этажей в доме. Не может быть меньше поля этажа квартиры"
        );
      table.date("yearOfConstruction").nullable().comment("Дата постройки");
      table
        .decimal("ceilingHeight", 4, 1)
        .nullable()
