...
export default class RealEstateValidator extends ApiValidator {
  ...
  public schema = schema.create({
    ...
    roomTypes: schema.array
      .optional()
      .members(
        schema.number([rules.unsigned(), rules.range(0, RoomsTypes.FREE)])
      ),
    startPrice: schema.number.optional([rules.unsigned()]),
    endPrice: schema.number.optional([rules.unsigned()]),
    rentalTypes: schema.array
      .optional()
      .members(
        schema.number([rules.unsigned(), rules.range(0, RentalTypes.DAILY)])
      ),
    repairTypes: schema.array
      .optional()
      .members(
        schema.number([rules.unsigned(), rules.range(0, RepairTypes.NO_REPAIR)])
      ),
    ...
    startTotalArea: schema.number.optional([rules.unsigned()]),
    endTotalArea: schema.number.optional([rules.unsigned()]),
    startLivingArea: schema.number.optional([rules.unsigned()]),
    endLivingArea: schema.number.optional([rules.unsigned()]),
    startKitchenArea: schema.number.optional([rules.unsigned()]),
    endKitchenArea: schema.number.optional([rules.unsigned()]),
    layoutTypes: schema.array
      .optional()
      .members(
        schema.number([
          rules.unsigned(),
    ...
    WCTypes: schema.array
      .optional()
      .members(
        schema.number([rules.unsigned(), rules.range(0, WCTypes.TWO_OR_MORE)])
      ),
    startFloor: schema.number.optional([rules.unsigned()]),
    endFloor: schema.number.optional([rules.unsigned()]),
    startMaxFloor: schema.number.optional([rules.unsigned()]),
    endMaxFloor: schema.number.optional([rules.unsigned()]),
    balconyTypes: schema.array
      .optional()
      .members(
        schema.number([rules.unsigned(), rules.range(0, BalconyTypes.SEVERAL)])
      ),
    houseBuildingTypes: schema.array
      .optional()
      .members(
        schema.number([
          rules.unsigned(),
